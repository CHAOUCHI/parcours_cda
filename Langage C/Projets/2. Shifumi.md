...
|Sauvegarde|A partir de la branch joueur-vs-ia, enregistré le score du joueur dans un fichier de sauvegarde| Vous pouvez lire un fichier avec `fgets()` et écrire un fichier avec la fonction `fprintf()` et `fopen()`. Voir exemple du cours basic.md : https://github.com/CHAOUCHI/parcours_cda/blob/master/Langage%20C/basic.md#le-filesystem-linux |
## Pré-requis
- variable
